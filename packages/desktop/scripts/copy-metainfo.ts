...
const productName = channel === "prod" ? "AI Org" : `AI Org ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      AI Org is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
