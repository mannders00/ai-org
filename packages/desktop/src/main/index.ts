...
const main = Effect.gen(function* () {
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "AI Org Dev")
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("ai-org://"))
    if (urls.length) {
  ...
  app.setAsDefaultProtocolClient("ai-org")
  registerRendererProtocol()
  setDockIcon()
  setupAutoUpdater()
  ...
  const needsMigration = ((): boolean => {
    ...
    return !existsSync(join(base, "ai-org", "ai-org.db"))
  })()
