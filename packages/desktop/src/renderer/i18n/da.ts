export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af AI Org er blevet downloadet. Vil du installere den og genstarte?",
