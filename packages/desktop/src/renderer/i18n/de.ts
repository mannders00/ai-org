export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von AI Org wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
