export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju AI Org-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} AI Org-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
