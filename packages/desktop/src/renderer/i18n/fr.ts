export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'AI Org a été téléchargée. Voulez-vous l'installer et redémarrer ?",
