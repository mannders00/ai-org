export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AI Org er lastet ned. Vil du installere den og starte på nytt?",
