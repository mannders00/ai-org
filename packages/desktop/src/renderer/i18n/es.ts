export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AI Org. ¿Quieres instalarla y reiniciar?",
