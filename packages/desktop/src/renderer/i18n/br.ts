export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do AI Org foi baixada. Você gostaria de instalá-la e reiniciar?",
