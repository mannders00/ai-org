export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of AI Org",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of AI Org has been downloaded, would you like to install it and relaunch?",
