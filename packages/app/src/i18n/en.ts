export const dict = {
  ...
  "session.agenda.view.today": "Today",
  "session.agenda.view.todos": "TODOs",
  "session.agenda.view.week": "Week",
  "session.agenda.view.deadlines": "Deadlines",
  "session.agenda.refresh": "Refresh",
  "session.agenda.error": "Failed to load agenda",
  "session.agenda.empty": "No agenda data",
  "session.agenda.activeClocks": "Active",
  "session.agenda.scheduled": "Scheduled",
  "session.agenda.deadlines": "Deadlines",
  "session.agenda.nothingToday": "Nothing scheduled for today",
